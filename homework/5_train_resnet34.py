...
parallel_threads = int(argv[1])
# This controls how many batches to prefetch
prefetch_buffer_size = int(argv[2]) # tf.data.AUTOTUNE
...
def prepare_data_loader(BATCH_SIZE):
    ...
    from modules.ilsvrc_dataset import get_datasets
    ...
    with open("modules/ilsvrc.json", 'r') as f:
        config = json.load(f)
